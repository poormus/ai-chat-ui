...
export default function Home() {
  ...
  async function handleInitialMessage() {
    const messageContentString =
      "Hello, I am a chatbot that can summarize text. Try typing a message to me and I will summarize it for you. Note that I can only summarize text and not context aware.Meaning i wont remember previous messages";
